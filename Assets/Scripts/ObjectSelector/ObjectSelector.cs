    ...
    public class ObjectSelector : MonoBehaviour
    {
        ...
        private void EndSelection()
        {
            ...
            foreach (var obj in objects)
            {
                ...
                var objPos = _mainCamera.WorldToViewportPoint(obj.transform.position);
        ...
        {
            var v1 = _mainCamera.ScreenToViewportPoint(_selectionStart);
            var v2 = _mainCamera.ScreenToViewportPoint(_selectionEnd);
            var min = Vector3.Min(v1, v2);
            var max = Vector3.Max(v1, v2);

            min.z = _mainCamera.nearClipPlane;
            max.z = _mainCamera.farClipPlane;
        ...
        private void DisplayInfo(ISelectableObject selectedObject)
        {
            ...
            titleUi.text = selectedObject.Name.ToUpper();
            subtitleUi.text = selectedObject.Description;
        }
